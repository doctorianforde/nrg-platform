...
| Import prototype questions | **Staging import done (2026-09-20)** — 4,728 rows in the review queue (`source='prototype-import'`, all `is_active=false`/`pending`), verified, RLS 15/15. **Blocked on:** Jade's clinical review/approval; prod import (needs migration `20260920050000` applied to prod first — never done); CLUSTER_ALIASES/topic-taxonomy call; the 269 copyright-flagged items |
