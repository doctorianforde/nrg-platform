...
export function ExamRunner({
  ...
  return (
    <div className="grid gap-5 lg:grid-cols-[1fr_16rem]">
      <div className="space-y-4">
        <div className="flex items-center justify-between gap-3">
          <p className="text-sm text-muted-foreground">
            Question <strong className="text-card-foreground">{index + 1}</strong> of{" "}
            {questions.length}
            <span className="ml-3">
        ...
        <section className="rounded-lg border border-border bg-card p-5 shadow-sm">
          ...
          <p className="mt-3 whitespace-pre-line text-[15px] leading-relaxed text-card-foreground">
            {q.body}
          </p>
          ...
          <div className="mt-5 flex items-center justify-between">
            <button
              ...
              className="rounded-md border border-border bg-card px-4 py-2 text-sm font-medium text-card-foreground hover:bg-muted disabled:opacity-40"
            >
              ← Previous
            </button>
            <button
              ...
              className="rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:bg-brand-800 disabled:opacity-40"
            >
              Next →
            </button>
          </div>
          ...
          {!confirming ? (
            <div className="flex flex-wrap items-center gap-3">
              <button
                ...
                className="rounded-md bg-primary px-5 py-2.5 text-sm font-semibold text-primary-foreground hover:bg-brand-800"
              >
                Submit exam
              </button>
            ...
            <div>
              ...
              <div className="mt-3 flex gap-3">
                <button
                  ...
                  disabled={pending}
                  onClick={submit}
                  className="rounded-md bg-primary px-5 py-2 text-sm font-semibold text-primary-foreground hover:bg-brand-800 disabled:opacity-50"
                >
                ...
                <button
                  ...
                  className="rounded-md border border-border bg-card px-5 py-2 text-sm font-medium text-card-foreground hover:bg-muted disabled:opacity-50"
                >
                  Keep working
                </button>
              </div>
      ...
      <aside className="rounded-lg border border-border bg-card p-4 shadow-sm lg:sticky lg:top-4 lg:self-start">
